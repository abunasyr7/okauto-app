            ...
            <nav className={footer}>
                <div className={footer__section}>
                    <Link to="/" className={links}>
                        <img src="/img/penalties-tab-icon.png" alt="penalties-tab" className={footer__image}/>
                        <p className={footer__text}>Штрафы</p>
                    </Link>
                </div>
                <div className={footer__section}>
                    <Link to="/insurance/" className={links}>
                        <img src="/img/shield-tab-bar-icon.png" alt="shield-tab" className={footer__image}/>
                        <p className={footer__text}>Страховка</p>
                    </Link>
                </div>
                <div className={footer__section}>
                    <Link to="/notifications/" className={links}>
                        <img src="/img/settings-notifications-icon.png" alt="settings-notifications" className={footer__image}/>
                        <p className={footer__text}>Уведомления</p>
                    </Link>
                </div>
                <div className={footer__section}>
                    <Link to="/settings/" className={links}>
                        <img src="/img/settings-tab-icon.png" alt="settings-tab" className={footer__image}/>
