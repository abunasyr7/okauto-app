    ...
    return (
        <section className={main__about}>
            ...
            <div className={card__title}>
                <img src="/static/img/about-app-icon.png" alt="about-app-icon" className={main__image}/>
            ...
            <div className={main__text}>
                ...
                <img src="/static/img/about-number-1.png" alt="about-number-1" width={34} height={14} className={image}/>
                ...
                <img src="/static/img/about-forbes.png" alt="about-forbes" width={50} height={14} className={image}/>
                <p className={text}>Также на сегодняшний день мы являемся самым быстрорастущим стартапом в Казахстане по версии Forbes.</p>
                <img src="/static/img/about-stores.png" alt="about-stores" width={50} height={20} className={image}/>
                <p className={text}>Мы достигли свыше 600 тыс. загрузок в AppStore и Google Play, и более 200 тыс. активных пользователей.</p>
                <img src="/static/img/about-goal.png" alt="about-goal" width={50} height={20} className={image}/>
