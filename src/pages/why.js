    ...
    return (
        <Layout>
            <section className={main__why}>
                ...
                <div className={card}>
                    <img src="/static/img/circled-pdf-icon.png" alt="circled-pdf-icon" className={image}/>
                ...
                <div className={card}>
                    <img src="/static/img/circled-shield-icon.png" alt="circled-shield-icon" className={image}/>
                    <h2>Лёгкая оплата</h2>
                ...
                <div className={card}>
                    <img src="/static/img/circled-card-icon.png" alt="circled-card-icon" className={image}/>
                    <h2>Безопасность</h2>
